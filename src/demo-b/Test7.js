                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                实际控制人
                                <br/>
                                席位：<span className={Test7Style["seatValue"]}>3</span>&nbsp;&nbsp; 占比：<span className={Test7Style["seatValue"]}>23.56%</span>
                                <br/>
                            ...
                            <td>
                                独立董事<br/>
                                席位：<span className={Test7Style["seatValue"]}>3</span>&nbsp;&nbsp; 占比：<span className={Test7Style["seatValue"]}>23.96%</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                一致行动人派驻董事会<br/>
                                席位：<span className={Test7Style["seatValue"]}>3
                                </span>&nbsp;&nbsp; 占比：<span className={Test7Style["seatValue"]}>23.56%</span>
                            </td>
                            <td>
                                <span className={Test7Style['seatMsgTableSign'] + " " + Test7Style['typeC']}></span>
                            </td>
