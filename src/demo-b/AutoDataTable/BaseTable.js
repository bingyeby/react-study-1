    ...
    */
    ...
    if (this.props.editable) {
      if (this.props.status === 'edit') {
        tools.push(<Button key="cancel" type="ghost" shape="circle-outline"
        ...
        tools.push(<Button key="submit" type="ghost" shape="circle-outline"
          size="small" onClick={this.props.onSave}
          className={styles['tool-btn']}
        >
          <Icon type="check" />
        </Button>)
      } else if (this.props.status === 'save') {
        tools.push(<Button key="save" type="primary" shape="circle-outline"
          size="small"
          className={styles['tool-btn']}
        >
          <Icon type="loading" />
        ...
        tools.push(<Tooltip title="保存失败,点击再次编辑">
          <Button key="error" className="errorbutton" type="primary" shape="circle-outline"
            size="small" onClick={this.props.onEdit}
            className={styles['tool-btn']}
          >
        ...
        */
        tools.push(<Button key="edit" type="ghost" shape="circle-outline"
          size="small" onClick={this.props.onEdit}
          className={styles['tool-btn']}
        >
          <Icon type="edit" />
    ...
    const { updateTime, editable, status, onSearch, onEdit, onCancel, onSave, ...otherProps } = this.props
    return (
      <div>
        {title}
        {searcher}
